...
// Roles routes (for testing without login)
Route::prefix('roles')->group(function () {
    ...
    Route::put('/{id}/permissions', [RoleController::class, 'assignPermissions'])->name('roles.assign-permissions');
});

// Admin Profile routes (for testing without login)
Route::prefix('admin')->group(function () {
    Route::get('/profile/{id}', [AdminProfileController::class, 'show'])->name('admin.profile.show');
    Route::put('/profile/{id}', [AdminProfileController::class, 'update'])->name('admin.profile.update');
    Route::put('/profile/{id}/change-password', [AdminProfileController::class, 'changePassword'])->name('admin.profile.change-password');
});
